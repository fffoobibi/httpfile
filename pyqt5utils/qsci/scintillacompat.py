...
class QsciScintillaCompat(QsciScintilla):
    ...
    ArrowFoldStyle = QsciScintilla.FoldStyle.BoxedTreeFoldStyle + 1  # QsciScintilla.FoldStyle.BoxedTreeFoldStyle.value + 1
    ...
    #     ):
    #         print( QsciScintilla.INDIC_CONTAINER,
    #            QsciScintilla.INDIC_MAX)
