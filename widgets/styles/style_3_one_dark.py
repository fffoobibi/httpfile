...
@register('one_dark', index=3)
class OneDarkStyle(BaseStyle):
    ## qss format
    ...
    border = '#333841'
    border_lighter = '#4F575F'

    foreground = '#A8AFBB'
    background_darker = '#21252B'
    background_lighter = '#323844'
    handler = '#46494D'
    hover = 'red'
    ...
    left_button = dict(color=foreground, checked='orange', background=background_darker, background_checked=background_lighter,
                       border_checked='#4269B9')

    editor_globals = {
        'selection': dict(background="#404859"),
        'caret': dict(background='#4269B9', foreground='#2C313C'),  # 光标颜色, 背景色
        'margin': dict(background='#282C34', foreground='#737984'),
        'font': dict(default='Microsoft YaHei UI', jetbrain='JetBrains Mono Medium'),
        'paper': dict(background='#282C34'),
